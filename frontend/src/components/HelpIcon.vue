...
<template>
  <svg width="26px" height="26px" viewBox="-4 0 64 64" xmlns="http://www.w3.org/2000/svg" fill="#000000">
    ...
    <g id="SVGRepo_iconCarrier">
      <path
        ...
        fill-rule="evenodd" clip-rule="evenodd" fill="#419152"></path>
      <path
      ...
      <g fill-rule="evenodd" clip-rule="evenodd">
        <path d="M55.96 20.377v1h-12.799s-6.312-1.26-6.129-6.707c0 0 .208 5.707 6.004 5.707h12.924z" fill="#41915219152">
        </path>
